                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <div className="feature-description-container">
                    ...
                    <p className="featureDescription">
                      6% of every transaction goes directly from BNB to USDT and
                      is distributed to our holders. That way you don’t impact
                      the charts just by collecting your rewards.
                    </p>
                  </div>
                </Box>
              </Paper>
            ...
            <div className="featureCard">
              <Paper
                ...
                sx={{
                  ...
                  borderRadius: "10px",
                  backgroundImage:
                    "linear-gradient(to right, #fe6806, #ff9900)",
                  mb: 2.5,
                  left: {
                    md: "65px",
                    lg: "65px",
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <div className="feature-description-container-NFT">
                    ...
                    <p className="featureDescription">
                      ...
                      Limited number with rare characteristics. These were built
                      to be featured and will brighten your day. Taking the ugly
                      out of crypto.
                    </p>
                  </div>
                </Box>
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <div className="feature-description-container">
                    ...
                    <p className="featureDescription">
                      ...
                      into a 1000x moonshot. Built for the community this is as
                      safe as it gets.
                    </p>
                  </div>
                </Box>
